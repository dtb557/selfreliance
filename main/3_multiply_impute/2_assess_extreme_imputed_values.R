# Make tables (one for each decade probably; 2011 is the only year for which the 
# topcodes differ within a decade trio of years, so might have to do separate 
# table for 2011) including (for each imputed income variable) mean observed 
# value, SD, max observed value, topcode, n to be imputed, 1.5/2.5/4 times 
# topcode and n cases above each
