...
fun.tab05 <- function(out.decomp) {
     ...
     tab05 <- cbind(c(out.decomp$f.7010.5$r.change.obs[1],
                    ...
                    c(999,out.decomp$f.7010.5$r.change.ev.win.share,999,999,999,
                          out.decomp$f.7010.5$r.change.sp.win.share,
                          out.decomp$f.7010.5$r.change.ot.win.share,
                          out.decomp$f.7010.5$r.change.xx.win.share,rep(999,7)),
                    c(999,out.decomp$f.7010.5$r.change.ev.bt.share,999,999,999,
                          out.decomp$f.7010.5$r.change.sp.bt.share,
                          out.decomp$f.7010.5$r.change.ot.bt.share,
                          out.decomp$f.7010.5$r.change.xx.bt.share,rep(999,7)),
                    c(out.decomp$m.7010.5$r.change.obs[1],
                    ...
                    c(999,out.decomp$m.7010.5$r.change.ev.win.share,999,999,999,
                          out.decomp$m.7010.5$r.change.sp.win.share,
                          out.decomp$m.7010.5$r.change.ot.win.share,
                          out.decomp$m.7010.5$r.change.xx.win.share,rep(999,7)),
                    c(999,out.decomp$m.7010.5$r.change.ev.bt.share,999,999,999,
                          out.decomp$m.7010.5$r.change.sp.bt.share,
                          out.decomp$m.7010.5$r.change.ot.bt.share,
                          out.decomp$m.7010.5$r.change.xx.bt.share,rep(999,7))   )
     ...
     rownames(tab05) <- c("Change","Due to Association","Due to Composition",
                           ...
                           "Due to Earnings Inequality","Due to Family Structure",
     ...
     tab05p <- cbind(c(out.decomp$f.7010.5.part$r.change.obs[1],
                      ...
                      100*out.decomp$f.7010.5.part$r.change.pi/out.decomp$f.7010.5.part$r.change.obs[1]),
                    c(999,out.decomp$f.7010.5.part$r.change.ev.win.share,999,999,999,
                          out.decomp$f.7010.5.part$r.change.sp.win.share,
                          out.decomp$f.7010.5.part$r.change.ot.win.share,
                          out.decomp$f.7010.5.part$r.change.xx.win.share,rep(999,5)),
                    c(999,out.decomp$f.7010.5.part$r.change.ev.bt.share,999,999,999,
                          out.decomp$f.7010.5.part$r.change.sp.bt.share,
                          out.decomp$f.7010.5.part$r.change.ot.bt.share,
                          out.decomp$f.7010.5.part$r.change.xx.bt.share,rep(999,5)),
                    c(out.decomp$m.7010.5.part$r.change.obs[1],
                      ...
                      100*out.decomp$m.7010.5.part$r.change.pi/out.decomp$m.7010.5.part$r.change.obs[1]),
                    c(999,out.decomp$m.7010.5.part$r.change.ev.win.share,999,999,999,
                          out.decomp$m.7010.5.part$r.change.sp.win.share,
                          out.decomp$m.7010.5.part$r.change.ot.win.share,
                          out.decomp$m.7010.5.part$r.change.xx.win.share,rep(999,5)),
                    c(999,out.decomp$m.7010.5.part$r.change.ev.bt.share,999,999,999,
                          out.decomp$m.7010.5.part$r.change.sp.bt.share,
                          out.decomp$m.7010.5.part$r.change.ot.bt.share,
                          out.decomp$m.7010.5.part$r.change.xx.bt.share,rep(999,5))   )
